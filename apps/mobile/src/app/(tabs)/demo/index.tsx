...
import { Button, Card, Text } from "@app/ui";
        ...
        <View className="gap-6">
          <Card variant="elevated">
            ...
            <View className="gap-3">
              <Button variant={"test"} onPress={() => Alert.alert("Success", "Works!")}>
                <Text>Primary Button</Text>
              </Button>

              <Button
                variant="secondary"
                onPress={() => Alert.alert("Info", "Secondary works!")}
              >
              ...
              <Button
                variant="destructive"
                onPress={() => Alert.alert("Destructive", "Delete action")}
              >
                <Text>Delete</Text>
              </Button>
            </View>
